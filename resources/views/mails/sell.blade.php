            ...
            <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                <tr>
                    <td align="left" valign="top" class="desktop">
                        <h3 class="mail_header" style="font-size:16px !important;">Hello! {{$sell->user->name}}</h3>

                        <p style="font-size:15px !important;">You have successfully sold <span style="font-weight:bold;">&#8358;{{ number_format($sell->amount_naira, 2) }}</span> 
                        worth <span style="font-weight:bold;">{{ number_format($sell->amount_bnb, 2) }} BNB</span>
